...
## Project Structure
    ...
    ├── django_test_app_one_16  # Django project configurations
...
1. Clone this repo and `cd django_test_app_one_16`
...
2. Clone this repo and `cd django_test_app_one_16`
